...
def home(request):
    ...
    activity_messages = Message.objects.all().filter(Q(room__topic__name__icontains=q))
...
def updateRoom(request, pk):
    ...
    if request.user != room.host:
        return HttpResponse('Only the creator of the room can edit or delete the room.')
...
def deleteMessage(request, pk):
    ...
    if request.user != message.user:
        return HttpResponse('Only the poster of the message can edit or delete the message.')
